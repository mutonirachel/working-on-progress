const addressBook = [
    {
      names: 'Rachel Mutoni',
      address: 'Kicukiro-Kanombe',
      email: 'mutonirachel20@gmail.com',
      phoneNumber: '+250780661186'
    },
  ]

  /*let LoginForm = document.body.LoginForm
  let LoginInfo = document.body.LoginInfo
...
Event.preventDefault()*/
  ...
  loginform.onsubmit =  evt=>{
    ...
    evt.preventDefault();
    const emailElt =  loginform.querySelector('input[name=email]');
